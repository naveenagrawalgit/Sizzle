  ...
  const navigate = useNavigate();
    ...
    const handleSubmit = async(e)=> {
      ...
      try {
        ...
        console.log("herror during form submission",error)
    ...
    <div className='max-w-2xl mx-auto p-4' >
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div>
          ...
          <button type='button' className='text-blue-500 hover:underline'  onClick={addIngredient} >Add Ingredients</button>
        </div>
        ...
        <div>
          ...
          <select 
          onChange={(e)=> handleInputChange("category",e.target.value)} value={formData.category} 
          className='w-full p-2 border rounded'
          required
          >
          ...
          <div>
          <label className='block text-gray-700'>Cooking Time (minute)</label>
          <input 
          type="number" 
